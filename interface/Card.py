...
class Card :
    ...
    def __init__(self, carte) :
        ...
        #self.power = power
        self.carte = carte
        self.name = carte["name"]
        self.health = carte["health"]
        self.healthMax = carte["health"]
        self.attack = carte["attack"]
        self.cost = carte["cost"]
        self.provoc = carte["provoc"]
        self.shield = carte["shield"]
        self.camo = carte["camo"]
        self.element = carte["element"]
        self.power = carte["power"]
