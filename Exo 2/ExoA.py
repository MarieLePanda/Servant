...
def main():
    ...
    cardSet = loadCardSet("C:\\Users\\lug13995\\Desktop\\ESGI\\Portable Python 3.2.5.1\\Exo 2\\cardSet")
...
def playTrun(player, ennemy):
    """Player can send servant to the field and attack ennemy servant
        Regler le soucie du servant qui ne doit attaquer qu'une fois.
    """
...
#Phase d'attaque
        ...
        for cardInField in servantCanAttack :
